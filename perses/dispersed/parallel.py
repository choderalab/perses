...
class Parallelism(object):
    ...
    def activate_client(self,
        ...
        """
        assert library in self.supported_libraries.items(), f"{library} is not supported in {self.supported_libraries}"
        ...
        if not library:
            ...
            if self.supported_libraries[library[0]] == 'LSF':
    ...
    def deactivate_client(self):
        ...
        delattr(Parallelism, 'library')
        delattr(Parallelism, 'client')
        delattr(Parallelism, '_adapt')
        delattr(Parallelism, 'num_processes')
        delattr(Parallelism, 'workers')
    ...
    def deploy(self, func, arguments, workers):
        """
    ...
    def gather_actor_result(self, future):
        ...
        if self.client is None:
            ...
            if self.library[0] == 'dask':
                ...
                raise raise Exception(f"{self.library} is supported, but without actor-gather functionality!")
