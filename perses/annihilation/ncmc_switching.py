...
class NCMCEngine(object):
    ...
    def integrate(self, topology_proposal, initial_positions, direction='insert', platform=None):
        ...
        # DEBUG
        logger.debug("NCMC logP %+10.1f | initial_total_energy %+10.1f kT | final_total_energy %+10.1f kT." % (logP_NCMC, integrator.getGlobalVariableByName('initial_total_energy'), integrator.getGlobalVariableByName('final_total_energy')))
