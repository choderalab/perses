...
def compare_energies(REST_system, other_system, positions, rest_atoms, T_min, T):
    ...
    angle_force = other_system_getForce(force_name_map['HarmonicAngleForce'])
    ...
    torsion_force = other_system.getForce(force_name_map['PeriodicTorsionForce'])
    ...
    nb_force = other_system.getForce(force_name_map['NonbondedForce'])
