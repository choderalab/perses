...
class FFAllAngleGeometryEngine(GeometryEngine):
    ...
    def _logp_propose(self, top_proposal, old_positions, beta, new_positions=None, direction='forward'):
        ...
        if direction=="forward":
            ...
            growth_system_generator = GeometrySystemGeneratorFast(top_proposal.old_system, atom_proposal_order.keys(),growth_parameter_name, reference_topology=top_proposal.old_topology)
