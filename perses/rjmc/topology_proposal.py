...
class SmallMoleculeSetProposalEngine(ProposalEngine):
    ...
    def propose(self, current_system, current_topology, current_mol=None, proposed_mol=None, current_metadata=None):
        ...
        # Add modified property to residues in the old topology
        for res in current_topology.residues():
            res.modified_aa = False

        # Add modified_aa property to residues in the new topology
...
class PremappedSmallMoleculeSetProposalEngine(SmallMoleculeSetProposalEngine):
    ...
    Note: When instantiating, set current_metadata['smiles'] as the starting smiles string (if you wish to consider stereochemistry)
