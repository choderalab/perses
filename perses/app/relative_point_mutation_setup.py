    ...
    def __init__(self,
        ...
        arguments
            ...
            extra_sidechain_map : dict, key: int, value: int, default None
                map of new to old sidechain atom indices to add to the default map
        ...
        for is_complex, (top, pos, sys) in enumerate(inputs):
            ...
            topology_proposal = point_mutation_engine.propose(sys, top, extra_sidechain_map=extra_sidechain_map)
