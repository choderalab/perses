...
class RelativeFEPSetup(object):
    ...
    def __init__(self, ligand_input, old_ligand_index, new_ligand_index, forcefield_files, phases,
                 ...
                 temperature=300.0 * unit.kelvin, solvent_padding=9.0 * unit.angstroms, atom_map=None,hydrogenmass = 4 * unit.amus):
        """
        ...
        self._hydrogen_mass = hydrogenmass
        ...
        if pressure is not None:
            ...
            self._system_generator = SystemGenerator(forcefield_files, barostat=barostat,
                                                     forcefield_kwargs={'removeCMMotion': False, 'nonbondedMethod': self._nonbonded_method,'constraints' : app.HBonds,'hydrogenMass': self._hydrogen_mass})
        else:
            self._system_generator = SystemGenerator(forcefield_files, forcefield_kwargs={'removeCMMotion': False,'nonbondedMethod': self._nonbonded_method,'constraints' : app.HBonds,'hydrogenMass': self._hydrogen_mass})
