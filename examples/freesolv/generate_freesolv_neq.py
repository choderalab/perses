...
substituted_benzene_names = ['benzene', 'chlorobenzene', 'dichlorobenzene', 'bromobenzene',
                             'naphthalene', 'ethylbenzene', 'propylbenzene', 'pentylbenzene']
...
if __name__=="__main__":
    ...
    for pair in itertools.permutations(substituted_benzene_names, 2):
        if pair[0] == pair[1]:
            continue
