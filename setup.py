...
setup(name='perses',
      ...
      packages=['perses', 'perses.storage', 'perses.scripts', 'perses.analysis', 'perses.samplers', 'perses.rjmc', 'perses.annihilation', 'perses.bias', 'perses.tests', 'perses.dispersed','perses.app','perses.utils'],
